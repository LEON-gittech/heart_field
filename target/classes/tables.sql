...
CREATE TABLE consultant (
  ...
  help_total_num int DEFAULT  0 COMMENT '总帮助次数，设置默认值为0',
  total_help_time int DEFAULT 0 COMMENT '总帮助时长，设置默认值为0',
  today_total_help_time int DEFAULT 0 COMMENT '今日总帮助时长，设置默认值为0',
  today_total_help_count int DEFAULT 0 COMMENT '今日总帮助次数，设置默认值为0',
