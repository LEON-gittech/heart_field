...
import com.example.heart_field.dto.binding.ConsultantBindedDto;
import com.example.heart_field.dto.consultant.ConsultantEasyDto;
import com.example.heart_field.dto.supervisor.*;
...
public class SupervisorController {
    ...
    public R<String> updateConsultantBindedMaxCount(@PathVariable("supervisor-id") String supervisorId, @RequestBody SupervisorConsultMaxCountDto supervisorConsultMaxCount){
        Supervisor supervisor = supervisorService.getById(supervisorId);
        User user = TokenUtil.getTokenUser();
